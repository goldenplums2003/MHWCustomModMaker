...
static void AppendMonsters(std::vector<FsmDbEntry>& db)
{
    ...
    static const M kM[] = {
        ...
        // 否则 11 段会连响 11 次。
        {"黑龙", 33008, "1转2 相变 · 第1段 起手 (2.3s，和2转3共用)"},
        {"黑龙", 33017, "1转2 相变 · 第2段 (1.6s)"},
        {"黑龙", 33018, "1转2 相变 · 第3段 (1.8s)"},
        {"黑龙", 33019, "1转2 相变 · 第4段 (2.3s)"},
        {"黑龙", 33020, "1转2 相变 · 第5段 (0.06s，极短)"},
        {"黑龙", 33021, "1转2 相变 · 第6段 (1.7s)"},
        {"黑龙", 33022, "1转2 相变 · 第7段 (2.9s)"},
        {"黑龙", 33023, "1转2 相变 · 第8段 (1.3s)"},
        {"黑龙", 33024, "1转2 相变 · 第9段 (5.9s)"},
        {"黑龙", 33025, "1转2 相变 · 第10段 (3.8s)"},
        {"黑龙", 33030, "1转2 相变 · 第11段 收尾 (5.3s)"},
        ...
        {"黑龙", 33042, "2转3 相变 · 第2段 (1.5s，二转三的分岔点，最早的可靠信号)"},
        {"黑龙", 33043, "2转3 相变 · 第3段 (1.8s)"},
        {"黑龙", 33044, "2转3 相变 · 第4段 (2.0s)"},
        {"黑龙", 33045, "2转3 相变 · 第5段 (0.06s，极短)"},
        {"黑龙", 33046, "2转3 相变 · 第6段 (1.8s)"},
        {"黑龙", 33047, "2转3 相变 · 第7段 (5.6s)"},
        {"黑龙", 33048, "2转3 相变 · 第8段 (1.3s)"},
        {"黑龙", 33049, "2转3 相变 · 第9段 (9.8s，最长)"},
        {"黑龙", 33050, "2转3 相变 · 第10段 (3.8s)"},
        {"黑龙", 33031, "2转3 相变 · 第11段 (6.0s)"},
        {"黑龙", 33029, "2转3 相变 · 第12段 收尾 (4.7s) —— 科目三顶的就是这段"},
        ...
        // ---- 黑龙：高频动作，招式名待认 ----
        {"黑龙", 28897, "高频动作 (0.55s，出现 258 次，最常见)"},
        {"黑龙", 28900, "高频动作 (0.91s，出现 190 次)"},
        {"黑龙", 28883, "高频动作 (0.73s，出现 120 次)"},
        {"黑龙", 28947, "高频动作 (0.38s，出现 98 次)"},
        {"黑龙", 28875, "高频动作 (1.77s，出现 83 次)"},
        {"黑龙", 33079, "长动作 (7.0s，出现 79 次)"},
        {"黑龙", 29175, "长动作 (7.2s)"},
        {"黑龙", 12326, "长动作 (12.0s)"},
        {"黑龙", 12370, "长动作 (13.0s)"},
    };
