...
// ===========================================================================
//  怪物动作。2026-09-18/19 实测，样本来自 11 把黑龙（多人血 171600 / 单人血
//  114972，两者动作 ID 交集 93%，确认是同一只怪）。
//
//  判定依据：动作总帧是动作 ID 的严格函数（340 种动作里 339 种总帧唯一），
//  而且相变序列在每一把里逐条对齐、连时长都一致到 0.1 秒。
//
...
static void AppendMonsters(std::vector<FsmDbEntry>& db)
{
    ...
    static const M kM[] = {
        // ---- 黑龙：一阶段 -> 二阶段 相变（血线 76~78%，整段约 19 秒）----
        // 每把都是这个顺序，时长一致。绑音效建议用前三个 + Group=，
        // 因为是一整招拆成的多段，不分组会连响。
        {"黑龙", 33022, "1转2 相变 · 第1段 (2.9s)"},
        {"黑龙", 33023, "1转2 相变 · 第2段 (1.3s)"},
        {"黑龙", 33024, "1转2 相变 · 第3段 (5.9s)"},
        {"黑龙", 33025, "1转2 相变 · 第4段 (3.9s)"},
        {"黑龙", 33030, "1转2 相变 · 第5段 (5.4s)"},

        // ---- 黑龙：二阶段 -> 三阶段 相变（血线 47~50%，整段约 33 秒）----
        // 伤害溢出时可能在更低的血线发生。33045 只有 0.1 秒，别单独绑。
        {"黑龙", 33045, "2转3 相变 · 第1段 (0.1s，极短)"},
        {"黑龙", 33046, "2转3 相变 · 第2段 (1.7s)"},
        {"黑龙", 33047, "2转3 相变 · 第3段 (5.6s)"},
        {"黑龙", 33048, "2转3 相变 · 第4段 (1.3s)"},
        {"黑龙", 33049, "2转3 相变 · 第5段 (9.8s，最长)"},
        {"黑龙", 33050, "2转3 相变 · 第6段 (3.9s)"},
        {"黑龙", 33031, "2转3 相变 · 第7段 (6.0s)"},
        {"黑龙", 33029, "2转3 相变 · 第8段 (4.7s)"},
        ...
        // ---- 黑龙：高频动作，招式名待认 ----
        {"黑龙", 28897, "高频动作 (0.55s，出现 59 次)"},
        {"黑龙", 28900, "高频动作 (0.84s，出现 41 次)"},
        {"黑龙", 28875, "高频动作 (1.77s，出现 31 次)"},
        {"黑龙", 28883, "高频动作 (0.73s，出现 28 次)"},
        {"黑龙", 28947, "高频动作 (0.38s，出现 28 次)"},
        {"黑龙", 28787, "疑似孕吐 (用户标注，未确认)"},
        {"黑龙", 33079, "长动作 (7.5s)"},
        {"黑龙", 29175, "长动作 (6.3s)"},
        {"黑龙", 12326, "长动作 (12.0s)"},
        {"黑龙", 12370, "长动作 (13.0s，多在 35~50% 血线)"},
    };
